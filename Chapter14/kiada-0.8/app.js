...
let failAfterSeconds = process.env.FAIL_AFTER_SECONDS || 30;
...
function handler(req, res) {
    ...
    if (Date.now() > startedAt + failAfterSeconds * 1000) {
        log("Simulating failure. Returning 500 Internal Error.");
        res.writeHead(500);
        res.write("This version of the app is configured to fail after " + failAfterSeconds + "s.");
        res.end();
        return;
    }
